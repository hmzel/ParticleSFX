...
public class ParticleMagicCrit extends Particle implements TravellingParticle {

    private Location toGo = null;
    private Vector velocity = null;

    public ParticleMagicCrit(Location toGo, double offsetX, double offsetY, double offsetZ, double speed, int count) {
    ...
    public ParticleMagicCrit(Location toGo, double speed, int count) {
