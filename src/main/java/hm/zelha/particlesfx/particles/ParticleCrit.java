...
public class ParticleCrit extends Particle implements TravellingParticle {

    private Location toGo = null;
    private Vector velocity = null;

    public ParticleCrit(Location toGo, double offsetX, double offsetY, double offsetZ, double speed, int count) {
    ...
    public ParticleCrit(Location toGo, double speed, int count) {
