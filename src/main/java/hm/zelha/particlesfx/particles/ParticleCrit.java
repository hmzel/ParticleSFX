...
public class ParticleCrit extends TravellingParticle {
    public ParticleCrit(Location toGo, double offsetX, double offsetY, double offsetZ, int count) {
        super((ParticleType) IRegistry.PARTICLE_TYPE.get(new MinecraftKey("crit")), false, 0.82, null, toGo, offsetX, offsetY, offsetZ, count);
    }

    public ParticleCrit(Vector velocity, double offsetX, double offsetY, double offsetZ, int count) {
        super((ParticleType) IRegistry.PARTICLE_TYPE.get(new MinecraftKey("crit")), false, 0.82, velocity, null, offsetX, offsetY, offsetZ, count);
    }
