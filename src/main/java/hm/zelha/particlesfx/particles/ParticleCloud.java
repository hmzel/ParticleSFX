...
public class ParticleCloud extends Particle implements TravellingParticle {

    private Location toGo = null;
    private Vector velocity = null;

    public ParticleCloud(Location toGo, double offsetX, double offsetY, double offsetZ, double speed, int count) {
    ...
    public ParticleCloud(Location toGo, double speed, int count) {
