...
public class ParticleBlockDust extends Particle implements MaterialParticle {
    ...
    public void setMaterial(Material material) {
        ...
        particle = new ParticleParamBlock((net.minecraft.server.v1_13_R1.Particle) net.minecraft.server.v1_13_R1.Particle.REGISTRY.get(new MinecraftKey("falling_dust")), ((CraftBlockData) material.createBlockData()).getState());
    }
