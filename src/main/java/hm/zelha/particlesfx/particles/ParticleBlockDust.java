...
public class ParticleBlockDust extends Particle implements MaterialParticle {
    public ParticleBlockDust(Material material, double offsetX, double offsetY, double offsetZ, int count) {
        super(null, offsetX, offsetY, offsetZ, 1, count);
    ...
    public void setMaterial(Material material) {
        ...
        particle = new ParticleParamBlock((net.minecraft.server.v1_16_R1.Particle) IRegistry.PARTICLE_TYPE.get(new MinecraftKey("falling_dust")), ((CraftBlockData) material.createBlockData()).getState());
    }
