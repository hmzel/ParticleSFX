...
public class ParticleBlockDust extends Particle implements MaterialParticle {
    ...
    public void setMaterial(Material material) {
        ...
        particle = new ParticleParamBlock((net.minecraft.server.v1_16_R2.Particle) IRegistry.PARTICLE_TYPE.get(new MinecraftKey("falling_dust")), ((CraftBlockData) material.createBlockData()).getState());
    }
