...
public class ParticleGlyph extends Particle implements InverseTravellingParticle {
    ...
    public ParticleGlyph(Location toGo, int count) {
        this(toGo, 0, 0, 0, count);
    }

    public ParticleGlyph(Vector velocity, int count) {
