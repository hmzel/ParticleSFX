...
public class ParticleFlame extends Particle implements TravellingParticle {

    private Location toGo = null;
    private Vector velocity = null;

    public ParticleFlame(Location toGo, double offsetX, double offsetY, double offsetZ, double speed, int count) {
    ...
    public ParticleFlame(Vector velocity, double offsetX, double offsetY, double offsetZ, double speed, int count) {
        ...
        if (velocity != null) this.velocity = velocity.multiply(0.07);
    }
    ...
    public ParticleFlame(Location toGo, double speed, int count) {
    ...
    public void setVelocity(Vector vector) {
        this.velocity = vector.multiply(0.07);
    }

    @Override
    public void setVelocity(double x, double y, double z) {
        this.velocity = new Vector(x, y, z).multiply(0.07);
    }
