...
public class ParticleInk extends TravellingParticle {
    public ParticleInk(Location toGo, double offsetX, double offsetY, double offsetZ, int count) {
        super((ParticleType) IRegistry.PARTICLE_TYPE.get(new MinecraftKey("squid_ink")), false, 0.099, null, toGo, offsetX, offsetY, offsetZ, count);
    }

    public ParticleInk(Vector velocity, double offsetX, double offsetY, double offsetZ, int count) {
        super((ParticleType) IRegistry.PARTICLE_TYPE.get(new MinecraftKey("squid_ink")), false, 0.099, velocity, null, offsetX, offsetY, offsetZ, count);
    }
