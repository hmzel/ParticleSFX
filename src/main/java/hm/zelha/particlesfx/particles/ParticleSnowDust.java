...
public class ParticleSnowDust extends Particle implements TravellingParticle {

    private Location toGo = null;
    private Vector velocity = null;

    public ParticleSnowDust(Location toGo, double offsetX, double offsetY, double offsetZ, double speed, int count) {
    ...
    public ParticleSnowDust(Location toGo, double speed, int count) {
