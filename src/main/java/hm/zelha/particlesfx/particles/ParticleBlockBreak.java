...
public class ParticleBlockBreak extends Particle implements MaterialParticle {
    ...
    public void setMaterial(Material material) {
        ...
        particle = new ParticleParamBlock((net.minecraft.server.v1_14_R1.Particle) IRegistry.PARTICLE_TYPE.get(new MinecraftKey("block")), ((CraftBlockData) material.createBlockData()).getState());
    }
