...
public class ParticlePoof extends TravellingParticle {
    public ParticlePoof(Location toGo, double offsetX, double offsetY, double offsetZ, int count) {
        super((ParticleType) IRegistry.PARTICLE_TYPE.get(new MinecraftKey("poof")), false, 0.085, null, toGo, offsetX, offsetY, offsetZ, count);
    }

    public ParticlePoof(Vector velocity, double offsetX, double offsetY, double offsetZ, int count) {
        super((ParticleType) IRegistry.PARTICLE_TYPE.get(new MinecraftKey("poof")), false, 0.085, velocity, null, offsetX, offsetY, offsetZ, count);
    }
