...
public class ParticleSwirlTransparent extends Particle implements ColorableParticle {
    ...
    public ParticleSwirlTransparent(@Nullable Color color, int brightness, double offsetX, double offsetY, double offsetZ, int count) {
        super(Effect.POTION_SWIRL_TRANSPARENT, offsetX, offsetY, offsetZ, 1, count, 0);
