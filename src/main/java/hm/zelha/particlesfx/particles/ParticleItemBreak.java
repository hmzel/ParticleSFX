...
public class ParticleItemBreak extends TravellingParticle implements MaterialParticle {
    ...
    public void setMaterial(Material material) {
        ...
        particle = new ParticleParamItem((net.minecraft.server.v1_15_R1.Particle) IRegistry.PARTICLE_TYPE.get(new MinecraftKey("item")), CraftItemStack.asNMSCopy(new ItemStack(material)));
    }
